...
resource "ncloud_server" "bastion" {
  server_image_product_code   = "SW.VSVR.OS.LNX64.UBNTU.SVR2004.B050"  # Ubuntu 20.04 이미지 사용
  server_product_code         = "SVR.VSVR.HICPU.C002.M004.NET.SSD.B050.G002"  # c2-g3 (vCPU 2EA, Memory 4GB)
